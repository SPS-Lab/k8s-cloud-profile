...
HEADNODESCRIPTS="setup-nfs-server.sh setup-nginx.sh setup-mpi-perf.sh setup-ssl.sh setup-kubespray.sh setup-kubernetes-extra.sh setup-end.sh"
WORKERNODESCRIPTS="setup-nfs-client.sh setup-mpi-perf.sh"
