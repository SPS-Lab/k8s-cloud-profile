...
HEADNODESCRIPTS="setup-nfs-server.sh setup-nginx.sh setup-ssl.sh setup-mpi-perf.sh setup-kubespray.sh setup-kubernetes-extra.sh setup-end.sh"
WORKERNODESCRIPTS="setup-mpi-perf.sh setup-nfs-client.sh"
